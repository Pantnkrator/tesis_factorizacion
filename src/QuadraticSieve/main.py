...
#single polynomial version of quadratic sieve, given smoothness bound B and sieve interval I
    ...
    # print("{} B-smooth numeros encontrados.".format(len(smooth_nums)))
...
# x = int(input())
# print(f'{x} = {QS(x,1000,100000)}')
# print(QS(37351160168752886641,1000,1000))
# print(QS(12653870692612480730956939119318990408305171,100000,100000000))
#print(QS(44619154012697354916874972804312121957361090119,1_000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          _000_000,1_000_000))
#print(QS(450094620862682215953169056804394023557088230914503061621591,4000,4000))
#print(QS(51887711213803354677207493948038953621564859177886491154411636348879189189752059388157,8000,8000))
#print(QS(5525839695464531120130380273523301144377584817479160270675635722146913620801767801853724599722008379503935030673596961,10000,10000))


for line in sys.stdin:
    line = int(line.strip())
    inicio = time.time()
    factores = QS(line, 1000, 100000)
    fin = time.time()
